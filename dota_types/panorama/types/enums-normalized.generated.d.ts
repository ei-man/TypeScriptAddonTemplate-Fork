...
declare const MODIFIER_FUNCTION_LAST: 388;
...
declare enum ModifierFunction {
     ...
     */
    INCOMING_PHYSICAL_DAMAGE_CONSTANT = 65,
    /**
     ...
     */
    INCOMING_SPELL_DAMAGE_CONSTANT = 66,
    /**
     ...
     */
    BUFF_AMPLIFICATION = 192,
    /**
     * Method Name: `OnSpellTargetReady`
     */
    ON_SPELL_TARGET_READY = 193,
    /**
     * Method Name: `OnAttackRecord`
     */
    ON_ATTACK_RECORD = 194,
    /**
     ...
     */
    ON_ATTACK_ALLIED = 199,
    /**
     * Method Name: `OnProjectileDodge`
     */
    ON_PROJECTILE_DODGE = 200,
    /**
     * Method Name: `OnOrder`
     */
    ON_ORDER = 201,
     ...
     */
    ON_ABILITY_START = 204,
    /**
     * Method Name: `OnAbilityExecuted`
     */
    ON_ABILITY_EXECUTED = 205,
    /**
     * Method Name: `OnAbilityFullyCast`
     */
    ON_ABILITY_FULLY_CAST = 206,
    /**
     * Method Name: `OnBreakInvisibility`
     */
    ON_BREAK_INVISIBILITY = 207,
    /**
     * Method Name: `OnAbilityEndChannel`
     */
    ON_ABILITY_END_CHANNEL = 208,
    ON_PROCESS_UPGRADE = 209,
    ON_REFRESH = 210,
    /**
     ...
     */
    PRESERVE_PARTICLES_ON_MODEL_CHANGE = 262,
    /**
     * Method Name: `OnAttackFinished`
     */
    ON_ATTACK_FINISHED = 263,
    /**
     ...
     */
    VISUAL_Z_SPEED_BASE_OVERRIDE = 267,
    INCOMING_DAMAGE_ILLUSION = 268,
    /**
     * Method Name: `GetModifierNoVisionOfAttacker`
     */
    DONT_GIVE_VISION_OF_ATTACKER = 269,
    /**
     ...
     */
    ON_ATTACK_RECORD_DESTROY = 271,
    /**
     * Method Name: `OnProjectileObstructionHit`
     */
    ON_PROJECTILE_OBSTRUCTION_HIT = 272,
    /**
     * Method Name: `GetSuppressTeleport`
     */
    SUPPRESS_TELEPORT = 273,
    /**
     * Method Name: `OnAttackCancelled`
     */
    ON_ATTACK_CANCELLED = 274,
    /**
     ...
     */
    PHYSICALDAMAGEOUTGOING_PERCENTAGE = 287,
    /**
     * Method Name: `GetModifierKnockbackAmplification_Percentage`
     */
    KNOCKBACK_AMPLIFICATION_PERCENTAGE = 288,
    /**
     ...
     */
    INCOMING_DAMAGE_CONSTANT = 290,
    /**
     * Method Name: `OnSpellAppliedSuccessfully`
     */
    SPELL_APPLIED_SUCCESSFULLY = 291,
    /**
     * Method Name: `GetModifierAvoidDamageAfterReductions`
     */
    AVOID_DAMAGE_AFTER_REDUCTIONS = 292,
    /**
     ...
     */
    ON_HERO_BEGIN_DYING = 332,
    /**
     * Method Name: `GetModifierBonusLotusHeal`
     */
    BONUS_LOTUS_HEAL = 333,
    /**
     * Method Name: `GetModifierBonusLotusHeal`
     */
    BASE_HP_REGEN_PER_STR_BONUS_PERCENTAGE = 334,
    /**
     * Method Name: `GetModifierBonusLotusHeal`
     */
    BASE_ARMOR_PER_AGI_BONUS_PERCENTAGE = 335,
    /**
     * Method Name: `GetModifierBonusLotusHeal`
     */
    BASE_MP_REGEN_PER_INT_BONUS_PERCENTAGE = 336,
    /**
     * Method Name: `GetModifierBonusLotusHeal`
     */
    BASE_MRES_PER_INT_BONUS_PERCENTAGE = 337,
    /**
...
declare enum KeybindCommand {
    ...
    KEYBIND_ABILITY_PRIMARY_1_QUICKCAST = 66,
    KEYBIND_ABILITY_PRIMARY_2_QUICKCAST = 67,
    KEYBIND_ABILITY_PRIMARY_3_QUICKCAST = 68,
    KEYBIND_ABILITY_SECONDARY_1_QUICKCAST = 69,
    KEYBIND_ABILITY_SECONDARY_2_QUICKCAST = 70,
    KEYBIND_ABILITY_ULTIMATE_QUICKCAST = 71,
    KEYBIND_ABILITY_PRIMARY_1_EXPLICIT_AUTOCAST = 72,
    KEYBIND_ABILITY_PRIMARY_2_EXPLICIT_AUTOCAST = 73,
    KEYBIND_ABILITY_PRIMARY_3_EXPLICIT_AUTOCAST = 74,
    KEYBIND_ABILITY_SECONDARY_1_EXPLICIT_AUTOCAST = 75,
    KEYBIND_ABILITY_SECONDARY_2_EXPLICIT_AUTOCAST = 76,
    KEYBIND_ABILITY_ULTIMATE_EXPLICIT_AUTOCAST = 77,
    KEYBIND_ABILITY_PRIMARY_1_QUICKCAST_AUTOCAST = 78,
    KEYBIND_ABILITY_PRIMARY_2_QUICKCAST_AUTOCAST = 79,
    KEYBIND_ABILITY_PRIMARY_3_QUICKCAST_AUTOCAST = 80,
    KEYBIND_ABILITY_SECONDARY_1_QUICKCAST_AUTOCAST = 81,
    KEYBIND_ABILITY_SECONDARY_2_QUICKCAST_AUTOCAST = 82,
    KEYBIND_ABILITY_ULTIMATE_QUICKCAST_AUTOCAST = 83,
    KEYBIND_ABILITY_PRIMARY_1_AUTOMATIC_AUTOCAST = 84,
    KEYBIND_ABILITY_PRIMARY_2_AUTOMATIC_AUTOCAST = 85,
    KEYBIND_ABILITY_PRIMARY_3_AUTOMATIC_AUTOCAST = 86,
    KEYBIND_ABILITY_SECONDARY_1_AUTOMATIC_AUTOCAST = 87,
    KEYBIND_ABILITY_SECONDARY_2_AUTOMATIC_AUTOCAST = 88,
    KEYBIND_ABILITY_ULTIMATE_AUTOMATIC_AUTOCAST = 89,
    KEYBIND_INVENTORY_1 = 90,
    KEYBIND_INVENTORY_2 = 91,
    KEYBIND_INVENTORY_3 = 92,
    KEYBIND_INVENTORY_4 = 93,
    KEYBIND_INVENTORY_5 = 94,
    KEYBIND_INVENTORY_6 = 95,
    KEYBIND_INVENTORYTP = 96,
    KEYBIND_INVENTORYNEUTRAL = 97,
    KEYBIND_INVENTORY_1_QUICKCAST = 98,
    KEYBIND_INVENTORY_2_QUICKCAST = 99,
    KEYBIND_INVENTORY_3_QUICKCAST = 100,
    KEYBIND_INVENTORY_4_QUICKCAST = 101,
    KEYBIND_INVENTORY_5_QUICKCAST = 102,
    KEYBIND_INVENTORY_6_QUICKCAST = 103,
    KEYBIND_INVENTORYTP_QUICKCAST = 104,
    KEYBIND_INVENTORYNEUTRAL_QUICKCAST = 105,
    KEYBIND_INVENTORY_1_AUTOCAST = 106,
    KEYBIND_INVENTORY_2_AUTOCAST = 107,
    KEYBIND_INVENTORY_3_AUTOCAST = 108,
    KEYBIND_INVENTORY_4_AUTOCAST = 109,
    KEYBIND_INVENTORY_5_AUTOCAST = 110,
    KEYBIND_INVENTORY_6_AUTOCAST = 111,
    KEYBIND_INVENTORYTP_AUTOCAST = 112,
    KEYBIND_INVENTORYNEUTRAL_AUTOCAST = 113,
    KEYBIND_INVENTORY_1_QUICKAUTOCAST = 114,
    KEYBIND_INVENTORY_2_QUICKAUTOCAST = 115,
    KEYBIND_INVENTORY_3_QUICKAUTOCAST = 116,
    KEYBIND_INVENTORY_4_QUICKAUTOCAST = 117,
    KEYBIND_INVENTORY_5_QUICKAUTOCAST = 118,
    KEYBIND_INVENTORY_6_QUICKAUTOCAST = 119,
    KEYBIND_INVENTORYTP_QUICKAUTOCAST = 120,
    KEYBIND_INVENTORYNEUTRAL_QUICKAUTOCAST = 121,
    KEYBIND_CONTROL_GROUP_1 = 122,
    KEYBIND_CONTROL_GROUP_2 = 123,
    KEYBIND_CONTROL_GROUP_3 = 124,
    KEYBIND_CONTROL_GROUP_4 = 125,
    KEYBIND_CONTROL_GROUP_5 = 126,
    KEYBIND_CONTROL_GROUP_6 = 127,
    KEYBIND_CONTROL_GROUP_7 = 128,
    KEYBIND_CONTROL_GROUP_8 = 129,
    KEYBIND_CONTROL_GROUP_9 = 130,
    KEYBIND_CONTROL_GROUP_10 = 131,
    KEYBIND_CONTROL_GROUPCYCLE = 132,
    KEYBIND_SELECT_ALLY_1 = 133,
    KEYBIND_SELECT_ALLY_2 = 134,
    KEYBIND_SELECT_ALLY_3 = 135,
    KEYBIND_SELECT_ALLY_4 = 136,
    KEYBIND_SELECT_ALLY_5 = 137,
    KEYBIND_SHOP_TOGGLE = 138,
    KEYBIND_SCOREBOARD_TOGGLE = 139,
    KEYBIND_COMBATLOG_TOGGLE = 140,
    KEYBIND_SCREENSHOT = 141,
    KEYBIND_ESCAPE = 142,
    KEYBIND_CONSOLE = 143,
    KEYBIND_DEATH_SUMMARY = 144,
    KEYBIND_LEARN_ABILITIES = 145,
    KEYBIND_LEARN_STATS = 146,
    KEYBIND_ACTIVATE_GLYPH = 147,
    KEYBIND_ACTIVATE_RADAR = 148,
    KEYBIND_PURCHASE_QUICKBUY = 149,
    KEYBIND_PURCHASE_STICKY = 150,
    KEYBIND_TOGGLE_BUYBACK_PROTECTION = 151,
    KEYBIND_GRAB_STASH_ITEMS = 152,
    KEYBIND_TOGGLE_AUTOATTACK = 153,
    KEYBIND_TOGGLE_OVERLAYMAP = 154,
    KEYBIND_OVERLAYMAP_INPUTKEY = 155,
    KEYBIND_FILTER_ENEMY = 156,
    KEYBIND_FILTER_ALLY = 157,
    KEYBIND_FILTER_HERO = 158,
    KEYBIND_FILTER_NONHERO = 159,
    KEYBIND_TAUNT = 160,
    KEYBIND_SHOP_CONSUMABLES = 161,
    KEYBIND_SHOP_ATTRIBUTES = 162,
    KEYBIND_SHOP_ARMAMENTS = 163,
    KEYBIND_SHOP_ARCANE = 164,
    KEYBIND_SHOP_BASICS = 165,
    KEYBIND_SHOP_SUPPORT = 166,
    KEYBIND_SHOP_CASTER = 167,
    KEYBIND_SHOP_WEAPONS = 168,
    KEYBIND_SHOP_ARMOR = 169,
    KEYBIND_SHOP_ARTIFACTS = 170,
    KEYBIND_SHOP_SIDE_PAGE_1 = 171,
    KEYBIND_SHOP_SIDE_PAGE_2 = 172,
    KEYBIND_SHOP_SECRET = 173,
    KEYBIND_SHOP_SEARCHBOX = 174,
    KEYBIND_SHOP_SLOT_1 = 175,
    KEYBIND_SHOP_SLOT_2 = 176,
    KEYBIND_SHOP_SLOT_3 = 177,
    KEYBIND_SHOP_SLOT_4 = 178,
    KEYBIND_SHOP_SLOT_5 = 179,
    KEYBIND_SHOP_SLOT_6 = 180,
    KEYBIND_SHOP_SLOT_7 = 181,
    KEYBIND_SHOP_SLOT_8 = 182,
    KEYBIND_SHOP_SLOT_9 = 183,
    KEYBIND_SHOP_SLOT_10 = 184,
    KEYBIND_SHOP_SLOT_11 = 185,
    KEYBIND_SHOP_SLOT_12 = 186,
    KEYBIND_SHOP_SLOT_13 = 187,
    KEYBIND_SHOP_SLOT_14 = 188,
    KEYBIND_SPEC_CAMERA_UP = 189,
    KEYBIND_SPEC_CAMERA_DOWN = 190,
    KEYBIND_SPEC_CAMERA_LEFT = 191,
    KEYBIND_SPEC_CAMERA_RIGHT = 192,
    KEYBIND_SPEC_CAMERA_GRIP = 193,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_1 = 194,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_2 = 195,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_3 = 196,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_4 = 197,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_5 = 198,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_6 = 199,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_7 = 200,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_8 = 201,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_9 = 202,
    KEYBIND_SPEC_CAMERA_SAVED_POSITION_10 = 203,
    KEYBIND_SPEC_UNIT_SELECT = 204,
    KEYBIND_SPEC_HERO_SELECT = 205,
    KEYBIND_SPEC_PAUSE = 206,
    KEYBIND_SPEC_CHAT = 207,
    KEYBIND_SPEC_SCOREBOARD = 208,
    KEYBIND_SPEC_INCREASE_REPLAY_SPEED = 209,
    KEYBIND_SPEC_DECREASE_REPLAY_SPEED = 210,
    KEYBIND_SPEC_STATS_ITEM = 211,
    KEYBIND_SPEC_STATS_GOLD = 212,
    KEYBIND_SPEC_STATS_XP = 213,
    KEYBIND_SPEC_STATS_FANTASY = 214,
    KEYBIND_SPEC_STATS_WINCHANCE = 215,
    KEYBIND_SPEC_FOW_TOGGLEBOTH = 216,
    KEYBIND_SPEC_FOW_TOGGLERADIENT = 217,
    KEYBIND_SPEC_FOW_TOGGLEDIRE = 218,
    KEYBIND_SPEC_OPEN_BROADCASTER_MENU = 219,
    KEYBIND_SPEC_DROPDOWN_KDA = 220,
    KEYBIND_SPEC_DROPDOWN_LASTHITS_DENIES = 221,
    KEYBIND_SPEC_DROPDOWN_LEVEL = 222,
    KEYBIND_SPEC_DROPDOWN_HEROFACET = 223,
